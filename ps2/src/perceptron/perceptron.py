...
def train_perceptron(kernel_name, kernel, learning_rate):
    ...
    """
    train_x, train_y = util.load_csv('D:\Coding\ps2\src\perceptron\\train.csv')
    ...
    test_x, test_y = util.load_csv('D:\Coding\ps2\src\perceptron\\test.csv')
